...
class YbImuSerial(object):
    ...
    def get_accelerometer_data(self, rounding=4):
        a_x, a_y, a_z = round(self._ax, rounding), round(self._ay, rounding), round(self._az, rounding)
        accel = (a_x, a_y, a_z)
    ...
    def get_gyroscope_data(self, rounding=4):
        g_x, g_y, g_z =round(self._gx, rounding), round(self._gy, rounding), round(self._gz, rounding)
        gyro = (g_x, g_y, g_z)
