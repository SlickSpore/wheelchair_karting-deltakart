...
def init_frame_buffer():
    ...
    fb_len = FB_HEIGHT * FB_WIDTH * BYTES_PER_PIXEL
...
def draw_grid(frame, center):
    return cv2.line(cv2.line(frame, (0, center[1]), (FB_WIDTH, center[1]), (0,0,255), 5), (center[0], 0), (center[0], FB_HEIGHT), (0,0,255), 5)
...
class KartHeadsetInput:
    ...
    def show_frame(self, frame):
        frame = draw_grid(frame, get_center_position(cvt_bb_to_rect(self.zero_bbox), axis=0))
